...
const page = () => {
    return (
        <div className="flex items-center justify-center flex-col md:mx-20 mx-5 md:gap-16 gap-4">
            <div className="flex flex-col justify-center items-center gap-8">
                <h2 className="md:text-4xl text-2xl font-medium">About</h2>
                <h5 className="md:text-2xl text-lg">Who we are and why we do what we do!</h5>
            </div>
            <div className="md:max-w-[650px] md:text-base text-sm">
            ...
            <div className="md:max-w-[650px] md:text-base text-sm">
                ...
                <div className="mt-8 md:text-base text-sm">
                    <h5 className="md:text-xl text-lg font-medium mb-2"> Here are some of the key aspects that define us:</h5>
                    <ul>
                        <li>
                            <span className="text-DarkGray md:text-lg text-base">Innovation</span> Continuously pushing the boundaries to create cutting-edge products.
                        </li>
                        <li>
                            <span className="text-DarkGray md:text-lg text-base">Customer Focus:</span> Listening to our customers and developing solutions that truly meet their needs.
                        </li>
                        <li>
                            <span className="text-DarkGray md:text-lg text-base">Integrity:</span> Upholding honesty and ethical standards in all our business practices.
                        </li>
                        <li>
                            <span className="text-DarkGray md:text-lg text-base">Excellence:</span> Striving for the highest quality in everything we do.
                        </li>
                    </ul>
                </div>
            </div>
