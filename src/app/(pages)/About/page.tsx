...
const page = () => {
    return (
        <div className="flex items-center justify-center flex-col mx-20 gap-16">
            ...
            <div>
                <Image src="/Blog/img1.png" width={800} height={800} alt="about" />
            </div>
            <div className="md:max-w-[650px]">
            ...
            <div>
                <Image src="/Blog/img4.png" width={500} height={500} alt="about" />
            </div>
            <div className="md:max-w-[650px]">
