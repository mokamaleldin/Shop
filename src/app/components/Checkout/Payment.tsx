                ...
                <div className="text-sm text-DarkGray">
                    <div className="my-4">
                        ...
                        <div className="w-full flex justify-end items-center relative">
                            <input type="text" placeholder={'**** **** **** ****'} className="border-b-2 focus:outline-none bg-LightGray text-sm border-Gray py-2 w-full" />
                        </div>
                    </div>
                    ...
                    <div className="my-4">
                        ...
                        <div className="w-full flex justify-end items-center relative">
                            <input type="text" placeholder={'MM/YY'} className="border-b-2 focus:outline-none bg-LightGray text-sm border-Gray py-2 w-full" />
                        </div>
                    </div>
                    ...
                    <div className="my-4">
                        ...
                        <div className="w-full flex justify-end items-center relative">
                            <input datepicker-format="mm/yy" id="card-expiration-input" type="text" placeholder={'Full Name'} className="border-b-2 focus:outline-none bg-LightGray text-sm border-Gray py-2 w-full" />
                        </div>
                    </div>
                </div>
